...
const translations = {
  ...
  vi: {
    ...
    about: {
      ...
      brideTitle: "Cô Dâu",
      groomBio:
        "Adrian là một kiến trúc sư tin rằng thiết kế tốt sẽ kết nối mọi người. Anh yêu thích những con đường mòn trên núi, nhiếp ảnh phim và khám phá những quán cà phê ẩn giấu trên khắp thế giới.",
      brideBio:
        "Sophia là một nhạc sĩ và nhà giáo dục, kết nối trái tim qua giai điệu và câu chuyện. Cô tìm thấy niềm vui trong khu vườn của mình, viết thơ lúc bình minh và khám phá nghệ thuật dưới mọi hình thức.",
    ...
    rsvp: {
      ...
      notePlaceholder: "Lời nhắn cho cặp đôi...",
      submitButton: "Gửi",
  ...
  ja: {
    ...
    about: {
      ...
      brideTitle: "新婦",
      groomBio:
        "Adrianは、良いデザインが人々をつなぐと信じる建築家です。山道のハイキング、フィルム写真、世界中の隠れたカフェを探すことを愛しています。",
      brideBio:
        "Sophiaは、メロディーとストーリーで心をつなぐミュージシャンであり教育者です。庭の手入れ、日の出の詩作、あらゆる形のアート探しに喜びを見出しています。",
      groomPhotoAlt: "新郎",
      bridePhotoAlt: "新婦",
    },
    venues: {
